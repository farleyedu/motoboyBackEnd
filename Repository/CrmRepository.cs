...
INSERT INTO crm_oportunidade (
    ...
    reuniao_reserva_id, reuniao_local, resposta_reserva_id, pagamento_reserva_id,
...
UPDATE crm_oportunidade
   SET coluna = @Coluna,
       ...
       proposta_json = @PropostaJson,
       proposta_enviada_em = @PropostaEnviadaEm,
       reuniao_reserva_id = @ReuniaoReservaId,
       reuniao_local = @ReuniaoLocal,
       resposta_reserva_id = @RespostaReservaId,
       pagamento_reserva_id = @PagamentoReservaId,
...
UPDATE crm_contrato
   SET status = COALESCE(@Status, status),
       ...
       data_inicio_cobranca = COALESCE(@DataInicioCobranca, data_inicio_cobranca),
